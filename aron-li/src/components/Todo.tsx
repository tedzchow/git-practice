...
>>>>>>> aron-li
  return (
    <div className="container mx-auto">
      ...
      <div className="">
        <div className="relative mb-3 flex justity-between align-center">
          <input
            type="email"
            ref={inputRef}
...
>>>>>>> aron-li
      ...
      <div>
<<<<<<< HEAD
        {todos.todoList.map((item: string, i) => (
          <div
            key={i}
            className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem] flex justify-between"
          >
=======
        {todos.todoList.map((item: string) => (
